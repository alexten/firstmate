...
| `fm-q-guard-lib.sh`      | Obtain, commit, and release durable Quartermaster child-spawn leases for opt-in Q-managed work |
| `fm-api.sh`              | Expose Q-managed worker lifecycle owners through one versioned JSON facade |
